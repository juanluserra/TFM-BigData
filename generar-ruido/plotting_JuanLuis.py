...
def n_detects_single(data_path: str="", data_dict: Dict[str, Any]={}, figsize: tuple=(10,6), ax=None, fig=None) -> None:
    """
...
def peak_freqs_single(data_path: str="", data_dict: Dict[str, Any]={}, figsize: tuple=(10,6), ax=None, fig=None) -> None:
    """
