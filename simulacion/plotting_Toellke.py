...
def plot_frequency_distribution(frequencies, label, save=False):
    """
...
def single_sim_analysis(file_path, showLFP, showEventLFP):
    ...
    plot_peak_frequencies([(research_param, all_spectrum_peaks),], sim_label, save=True)
    plot_power_spectral_density_bands([(research_param, band_spectra),], sim_label, save=True)
