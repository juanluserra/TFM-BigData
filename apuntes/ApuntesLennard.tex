...
Todas las neuronas y los parámetros relacionados con la sinapsis pueden ser ajustdos para explorar los efectos en la actividad neuronal. En las versiones más nuevas, se pueden ajustar fácilmente aspectos más generales del modelo.
